...
date: '2021-07-22'
tags: ['software-development', 'software-engineering', 'clean-code', 'JavaScript']
draft: false
...
images: ['/static/images/clean-code-big-picture.png']
---

<Image
  alt={`clean-code`}
  src={`/static/images/clean-code-big-picture.png`}
  width={1440}
  height={960}
  priority
/>
