---
title: 'Python tip N1 : simple ways to merge dictionaries in Python'
date: '2023-01-29'
tags: ['python', 'dictionaries', 'beginners', 'tips']
draft: false
summary: 'How you can merge your Python dictionnaries in one line'
images: ['/static/images/merge-python-dictionaries.png']
---

<Image
  alt={`Merge-python-dictionaries`}
  src={`/static/images/merge-python-dictionaries.png`}
  width={1440}
  height={960}
  priority
/>
