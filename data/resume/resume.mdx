...
Lead developer - Actually in Paris, France

## Working Experiences

### BNP Paribas Asset Management

<div className="!mt-0 text-sm italic text-gray-400">Paris - France, 2024 - Now</div>

- **Position:** Lead Developer.
- **Description:** Lead developer within the Business Unit Referential solutions
- **Projects:**
  - Flowr app which is an app for managing the lifecycle of the financial products created within BNP Paribas Asset Management
  - AI Discovery which is an app for gathering all AI initiatives whithin BNP Paribas Asset Management
- **Responsabilities:**
  - Requirements gathering and analysis.
  - Fullstack development with Flask and React
  - Hiring and onboarding new developers
  - Presentations of new features in front of stackholders 
  - Code reviews
  - Technical management of Cloud infrastructure and kubernetes namespaces of the application
  - Release Management and production deployment

- **Technologies**: Python, Flask, SQLAlchemy, Docker, AzDevops, IBM Cloud, kubernetes, Docker, JavaScript, React

### BPCE-IT

<div className="!mt-0 text-sm italic text-gray-400">Nantes - France, 2023 - 2024 (1 year)</div>
...
<div className="!mt-0 text-sm italic text-gray-400">Remote, 2020 - 2023 (3 years)</div>
...
<div className="!mt-0 text-sm italic text-gray-400">Casablanca - Morocco, 2020 - 2022 (2 years)</div>
...
<div className="!mt-0 text-sm italic text-gray-400">Rabat - Morocco, 2018 - 2019 (1 year)</div>
...
<div className="!mt-0 text-sm italic text-gray-400">Kenitra - Morocco, 2016 - 2018 (1 year)</div>
